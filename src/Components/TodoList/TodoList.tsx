    ...
    return (
        <div className='wrapper'>
            <div className='display__flex '>
                <div><input onChange={(e) => { setInput(e.target.value)  ;setInputval(e.target.value)}}  value={inputvalue} type='text' placeholder='please enter todo text' /> </div>
                <div><Button buttonAction={addTodoItem} text="add todo"/></div>
            </div>
            ...
            {todoList.map((todo: Todo) => (
                <div className='todo__list' key={todo.id}>
                    ...
                    <div className='todo__list__button'>
                        <Button text="delete" buttonAction={() => deleteTodoITem(todo.id) }/>
                   </div>
